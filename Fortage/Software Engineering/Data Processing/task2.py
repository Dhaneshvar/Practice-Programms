...
# DATA_DIRECTORY = "./data" # name of Input File
DATA_DIRECTORY = "D:/Git (June)/Practice-Programms/Fortage/Software Engineering/quantium-starter-repo-main/data"
OUTPUT_FILE_PATH = "./result.csv" # name of Output File
            ...
            for input_row in reader:
                ...
                if row_index > 0:
                    ...
                    if product == "pink morsel":
                        ...
                        price = float(raw_price[1:]) # Removing '$' so string slicing
